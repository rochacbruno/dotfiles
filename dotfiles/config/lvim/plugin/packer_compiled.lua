...
_G.packer_plugins = {
  ...
  ["Onedarker.nvim"] = {
    loaded = true,
    path = "/home/rochacbruno/.local/share/lunarvim/site/pack/packer/start/Onedarker.nvim",
  ...
  ["lush.nvim"] = {
    loaded = true,
    path = "/home/rochacbruno/.local/share/lunarvim/site/pack/packer/start/lush.nvim",
  ...
  ["synthwave84.nvim"] = {
    loaded = true,
    path = "/home/rochacbruno/.local/share/lunarvim/site/pack/packer/start/synthwave84.nvim",
  ...
  ["templeos.nvim"] = {
    loaded = true,
    path = "/home/rochacbruno/.local/share/lunarvim/site/pack/packer/start/templeos.nvim",
  ...
  ["vim-enfocado"] = {
    loaded = true,
    path = "/home/rochacbruno/.local/share/lunarvim/site/pack/packer/start/vim-enfocado",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lastplace', 'Comment.nvim', 'diffview.nvim', 'nvim-spectre', 'lsp_signature.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
