...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'diffview.nvim', 'nvim-spectre', 'nvim-lastplace', 'gitsigns.nvim', 'Comment.nvim', 'lsp_signature.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
