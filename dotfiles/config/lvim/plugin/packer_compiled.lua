...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lastplace', 'Comment.nvim', 'gitsigns.nvim', 'nvim-spectre', 'diffview.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
