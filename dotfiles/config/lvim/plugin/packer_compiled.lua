...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lastplace', 'nvim-spectre', 'Comment.nvim', 'diffview.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
