...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'hop.nvim', 'diffview.nvim', 'gitsigns.nvim', 'nvim-spectre', 'nvim-lastplace', 'Comment.nvim', 'lsp_signature.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
