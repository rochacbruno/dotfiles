...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'gitsigns.nvim', 'diffview.nvim', 'nvim-spectre', 'nvim-lastplace'}, { event = "BufRead *" }, _G.packer_plugins)]]
