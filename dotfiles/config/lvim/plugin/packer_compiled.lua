...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lastplace', 'Comment.nvim', 'diffview.nvim', 'gitsigns.nvim', 'nvim-spectre'}, { event = "BufRead *" }, _G.packer_plugins)]]
